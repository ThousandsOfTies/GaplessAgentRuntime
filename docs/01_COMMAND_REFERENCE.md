...
`~/Yurufuwa/gar-tools/firmware-runners/esp32/renode/ROADMAP.md` を参照。
...
```bash
~/Yurufuwa/gar-tools/firmware-runners/esp32/bin/gar-esp32-flash-image \
...
~/Yurufuwa/gar-tools/firmware-runners/esp32/bin/gar-esp32-qemu-run \
